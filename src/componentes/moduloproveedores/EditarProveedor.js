...
class EditarProveedor extends Component {
  ...
  getProveedor = (id) => {
    axios
      .get("http://localhost:8080/api/v1/mostrarProveedor/" + id)
      .then((res) => {
        this.setState({
          proveedor: res.data,
        });
        ...
        <form class="formulario" onSubmit={this.guardarProveedor}>
          <div class="ctexto">
            ...
            <input
              ...
              name="Nit"
              ref={this.nit}
              defaultValue={this.state.proveedor.id}
            />
          </div>
          <div class="ctexto">
            ...
            <input
              ...
              name="proveedor"
              ref={this.proveedor}
              defaultValue={this.state.proveedor.nombredelproveedor}
            />
          </div>
          <div class="ctexto">
            ...
            <input
              ...
              type="text"
              name="direccion"
              ref={this.direccion_proveedor}
              defaultValue={this.state.proveedor.direccion}
            />
          </div>
          <div class="ctexto">
            <label>Ciudad</label>
            <input
              ...
              type="text"
              name="ciudad"
              ref={this.ciudad_proveedor}
              defaultValue={this.state.proveedor.ciudad}
            />
          </div>
          <div class="ctexto">
            ...
            <input
              ...
              type="text"
              name="telefono"
              ref={this.telefono_proveedor}
              defaultValue={this.state.proveedor.telefono}
            />
          </div>
          <div class="ctexto">
            <label>Email</label>
            <input
              ...
              type="text"
              name="email"
              ref={this.email_proveedor}
              defaultValue={this.state.proveedor.email}
            />
          </div>
          <div>
            <input class="btnguardar" type="submit" />
            <a href="/Proveedores" class="btncancelar">
              {" "}
              Cancelar{" "}
            </a>
          </div>
